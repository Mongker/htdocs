			...
			<?php
				...
				while ($row=mysqli_fetch_array($kq)) {
					...
					echo "<tr style='background: #ffd4aa; height: 30px; vertical-align: middle;'>";
						...
						echo "<td class='auto4'><a href='../Controller/sinhvien_update.php?id=".$id."'><img src='../image/edit.gif'>";
						echo "<td class='auto4'></a><a href='../Model/sinhvien_delete.php?id=".$id."'><img src='../image/delete.gif'></a></td>";
					echo "</tr>";	
					# code...
				}
			?>
