	...
	<table align="center" width="100%" style="vertical-align: middle; border: 1px;border-color:#e5e5e5;  background: #e5e5e5;">
		<tbody>
			...
			<?php
				...
				$sql="SELECT * FROM lophoc where tenlop like '%$find%'";
				...
				while ($row=mysqli_fetch_array($kq)) {
					...
					echo "<tr style='background: #ffd4aa; height: 30px; vertical-align: middle;'>";
						...
						echo "<td class='auto4'><a href='../Controller/Lophoc_update.php?ml=".$malop."'><img src='../image/edit.gif'>";
						echo "<td class='auto4'></a><a href='../Model/Lophoc_delete.php?ml=".$malop."'><img src='../image/delete.gif'></a></td>";
					echo "</tr>";	
					# code...
				}
			?>
