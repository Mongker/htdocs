<div class="row">
	<ol class="breadcrumb">
		...
		<li class="active">Chi tiết hóa đơn bán</li>
	</ol>
</div><!--/.row-->
							...
							foreach ($list_product as $value) { 
								...
								<tr>
									...
									<!-- <?php if ($transaction->status=='0') { ?>
							            ...
							            <a href="<?php echo admin_url('hoadonban/deldetail/'.$value->order_id) ?>" title="Xóa"> <span class="glyphicon glyphicon-remove" onclick=" return confirm('Bạn chắc chắn muốn xóa')"></span> </a>
								    </td> 
										<?php
									} ?>
