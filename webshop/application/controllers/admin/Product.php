...
class Product extends MY_Controller {
	...
	public function index()
	{
		...
		$this->db->select('product.id as id,product.name as name,price,discount,image_link,view,soluong,buyed,catalog.name as namecatalog');
	...
	public function add()
	{
		...
		if ($this->input->post()) {
			...
			$this->form_validation->set_rules('soluong','Số lượng sản phẩm','required|numeric');
