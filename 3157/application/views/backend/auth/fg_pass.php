<div class="login-container col-md-4 col-md-offset-4" id="password-sent">
    <div class="login-frame clearfix">
        ...
        <p class="col-md-10 col-md-offset-1 padd-0">Nếu bạn là nhân viên, vui lòng liên hệ chủ cửa hàng để lấy lại mật khẩu!</p>
        <div class="col-md-10 col-md-offset-1">
            <form class="form-horizontal login-form" method="post" action="backend/authentication/fg_password">
    ...
    <div class="link-action text-center">
        <div class="col-sm-6 col-xs-12">
            <a href="backend/authentication" style="display:inline-block; margin-top: 5px;" class="login">Đăng nhập</a>
        </div>
        <div class="col-sm-6 col-xs-12">
