                ...
                <div class="col-md-6">
                    <div class="right-action text-right">
                        <div class="btn-groups">
                            <button type="button" class="btn btn-primary" name="" onclick="cms_save_orders('saved_termp')"><i class="fa fa-floppy-o"></i> Lưu tạm</button>
                            <button type="button" class="btn btn-primary" name="" onclick="cms_save_orders('save')"><i class="fa fa-check"></i> Lưu</button>
                                ...
                                <div class="form-group marg-bot-10 clearfix">
                                    ...
                                    <div class="col-md-8">
                                        <div class="col-md-10 padd-0" style="position: relative;">
                                            ...
                                            <div id="cys-suggestion-box" style="border: 1px solid #444; display: none; overflow-y: auto;background-color: #fff; z-index: 2 !important; position: absolute; left: 0; width: 100%; padding: 5px 0px; max-height: 400px !important;"><div class="search-cys-inner"></div></div>
                                        </div>
                        ...
                        <div class="morder-info" style="padding: 4px;">
                            <div class="tab-contents" style="padding: 8px 6px;">
                                ...
                                <div class="form-group marg-bot-10 clearfix">
                                    ...
                                    <div class="col-md-8">
                                        <div class="discount-order">0</div>
                                    </div>
                                </div>
                                <div class="form-group marg-bot-10 clearfix">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-8">
                                        <div class="count_money_order monney-order">
                                            0
                                        </div>
                                    </div>
                                </div>
