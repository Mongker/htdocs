    ...
    <div class="col-md-11 padd-0">
        ...
        <div class="col-md-3 padd-right-0">
            <div class="report-box " style="border: 1px dotted #ddd; border-radius: 0">
                ...
                <div class="infobox-data">
                    <h3 class="infobox-title orange" style="font-size: 25px;"><?php echo (isset($totaloinvent) ? cms_currency_format($totaloinvent) : '0');?></h3>
        ...
        <div class="col-md-3 padd-right-0">
            <div class="report-box" style="border: 1px dotted #ddd; border-radius: 0">
                ...
                <div class="infobox-data">
                    <h3 class="infobox-title cred" style="font-size: 25px;"><?php echo (isset($totalsinvent) ? cms_currency_format($totalsinvent) : '0');?></h3>
...
<table class="table table-bordered table-striped">
    ...
    <?php if ( isset( $data[ '_list_product' ] ) && count( $data[ '_list_product' ] ) ) :
          foreach ( $data[ '_list_product' ] as $key => $item ) : ?>
              <tr>
                  <td class="" onclick="cms_view_product(<?php echo $item['ID']; ?>)" style="color: #2a6496; cursor: pointer;">SP000<?php echo $item[ 'ID' ]; ?></td>
                  <td class="text-left" onclick="cms_view_product(<?php echo $item['ID']; ?>)" style="color: #2a6496; cursor: pointer; width: 600px; text-transform: uppercase;"><?php echo $item[ 'prd_name' ]; ?></td>
                  <td class="text-center"><?php echo $item[ 'prd_sls' ]; ?></td>

                  <td class="text-right"><?php echo cms_currency_format( $item[ 'prd_origin_price' ] * $item[ 'prd_sls' ] ); ?></td>
                  <td class="text-right"><?php echo cms_currency_format( $item[ 'prd_sell_price' ] * $item[ 'prd_sls' ] ); ?></td>
              </tr>
    <?php endforeach;
    else :
