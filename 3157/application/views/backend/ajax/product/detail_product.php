                ...
                <div class="col-md-6">
                    <div class="right-action text-right">
                        <div class="btn-groups">
                            <button type="button" class="btn btn-primary" style="background-color: #8B8B8B;" onclick="cms_change_status(<?php echo $_detail_product['ID']; ?>)"><i class="fa fa-pause"></i> Ngừng KD</button>
                            <button type="button" class="btn btn-primary "  onclick=""><i class="fa fa-pencil-square-o"></i> Sửa</button>
                            <button type="button" class="btn btn-danger"  onclick="cms_del_temp_product(<?php echo $_detail_product['ID']; ?>)"><i class="fa fa fa-trash-o"></i> Xóa</button>
                    ...
                    <div class="col-md-8">
                        <div class="row">
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="col-md-6">
                                    <div style="padding-bottom: 5px; font-weight: 700; color: #9d9d9d; "><span>Theo dõi tồn kho :</span> <?php echo ( isset($_detail_product['prd_inventory']) && ($_detail_product['prd_inventory'] == '1') ) ? '<span class="yes">Có</span>' : '<span class="no">Không</span>'; ?></div>
                                </div>
                            </div>
                            ...
                            <div class="form-group clearfix">
                                <div class="col-md-6 padd-left-0">
                                    ...
                                    <div class="col-md-12 padd-0">
                                       <div><?php echo ( cms_getNamegroupbyID($_detail_product['prd_group_id']) == 'Chưa có') ? 'Chưa có nhóm hàng': cms_getNamegroupbyID($_detail_product['prd_group_id']); ?></div>
                                    </div>
                                </div>
                                <div class="col-md-6 padd-right-0">
                                    <label>Chủng loại</label>
                                    <div class="col-md-12 padd-0">
                                        <div><?php echo ( cms_getNamecategorybyID($_detail_product['prd_category_id']) == 'Chưa có') ? 'Chưa có chủng loại': cms_getNamecategorybyID($_detail_product['prd_category_id']); ?></div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group clearfix">
                                <div class="col-md-6 padd-0">
                                    ...
                                    <div><?php echo $_detail_product['prd_vat'].'%'; ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-8">
                            <div class="row">
                                ...
                                <div class="col-md-12 padd-0">
                                    ...
                                    <textarea readonly class="tiny_editor" id="prd_description"><?php echo $_detail_product['prd_descriptions']; ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 padd-0">
                        ...
                        <div class="col-md-8">
                            <div class="row">
                                <div class="checkbox-group" style="margin-top: 20px;">
                                    <label class="checkbox"><input type="checkbox" disabled <?php echo ($_detail_product['display_website'] == 1) ? 'checked' : ''; ?>  class="checkbox" id="display_website"><span></span> Hiện thị ra website</label>
                                    <br>
                                    <label class="checkbox"><input type="checkbox" disabled <?php echo ($_detail_product['prd_highlight'] == 1) ? 'checked' : ''; ?> class="checkbox" ><span></span> Nổi bật</label>&nbsp;&nbsp;<label class="checkbox"><input type="checkbox" disabled class="checkbox" <?php echo ($_detail_product['prd_new'] ==1) ? 'checked' : ''; ?>><span></span> Hàng mới</label>&nbsp;&nbsp;&nbsp;<label class="checkbox"><input type="checkbox" disabled <?php echo ($_detail_product['prd_hot'] ==1) ? 'checked' : ''; ?> class="checkbox" id="prd_hot"><span></span> Đang bán chạy</label>
                                </div>
                            </div>
