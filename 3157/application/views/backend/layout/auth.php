...
<head>
    ...
    <link href="public/templates/backend/css/main.css" rel="stylesheet">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                <img src="public/templates/backend/images/logoqn.png" alt="Quang na" class="img-responsive col-sm-4 col-sm-offset-4" style="padding: 15px;" />
            </div>
        </div>
    </div>
</header>
